...
;; 中国农历节日
(add-to-list 'load-path "~/.emacs.d/elpa/cal-china-x-20170122.1100")
(require 'cal-china-x)
...
(setq calendar-longitude +116.15)
...
(setq my-holidays  '(;;公历节日
                         ...
                         ;;纪念日
                         (holiday-lunar 2 29 "爸爸生日" 0)
                         (holiday-lunar 11 16 "妈妈生日" 0)
                         (holiday-fixed 1 1 "儿子生日")
                         (holiday-lunar 2 2 "老婆生日"  0)
                         (holiday-lunar 8 17 "我的生日" 0)))
...
(setq diary-file "~/GTD/diary");; 默认的日记文件
(setq diary-mail-addr "kyleemail@163.com")
